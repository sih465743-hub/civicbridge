...
//#endregion
//#region migrations/0002_civic.sql?raw
...
//#endregion
//#region migrations/0003_seed.sql?raw
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-BzrKyXF3.js").then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { assertSameSiteRequest } = await import("./isolation.server-CGNg1r0B.js");
	const { requireUserId } = await import("./verify.server-C00gK-Tk.js");
