...
var c$1 = Object.getOwnPropertyDescriptor;
var f$1 = Object.getOwnPropertyNames;
var l = Object.getPrototypeOf;
var s$1 = Object.prototype.hasOwnProperty;
var a$1 = (t) => {
	throw TypeError(t);
};
...
var D$1 = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
var F = (t, e) => {
...
var g = (t, e, o, m) => {
	if (e && typeof e == "object" || typeof e == "function") for (let r of f$1(e)) !s$1.call(t, r) && r !== o && i(t, r, {
		get: () => e[r],
		enumerable: !(m = c$1(e, r)) || m.enumerable
	});
	return t;
};
var L = (t, e, o) => (o = t != null ? p$1(l(t)) : {}, g(e || !t || !t.__esModule ? i(o, "default", {
	value: t,
	enumerable: !0
}) : o, t));
var P = (t, e, o) => _(t, typeof e != "symbol" ? e + "" : e, o);
var n = (t, e, o) => e.has(t) || a$1("Cannot " + o);
var h$1 = (t, e, o) => (n(t, e, "read from private field"), o ? o.call(t) : e.get(t));
var R = (t, e, o) => e.has(t) ? a$1("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o);
...
var s = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && !h();
var m = "/pglite";
var y = globalThis && typeof globalThis.process < "u" ? globalThis.process : { exitCode: void 0 };
var a = /* @__PURE__ */ new Map();
async function c(t) {
	s || a.has(t.toString()) || a.set(t.toString(), fetch(t));
}
var o = /* @__PURE__ */ new Map();
async function b(t, e, r) {
	if (r || o.has(e.toString())) {
		let i = r || o.get(e.toString());
		return {
	...
	if (s) {
		let i = await (await import("./promises-qVRZAaH3.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).readFile(e), { module: n, instance: l } = await WebAssembly.instantiate(i, t);
		return o.set(e.toString(), n), {
			instance: l,
			module: n
		};
	} else {
...
async function w(t) {
	return s ? (await (await import("./promises-qVRZAaH3.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).readFile(t)).buffer : (c(t), (await a.get(t.toString())).clone().arrayBuffer());
}
var S = () => {
...
var ie = D$1((Jr, P) => {
	"use strict";
	u$1();
	var ye = Y(), T = W(), tr = 512, oe = T.TPERMALL, Fe = 0, he = 0, ae = [
		[
			"name",
			100,
			0,
...
async function at(e, r, t) {
	...
	for (let l of s) {
		...
		l.type === D.REGTYPE ? (e.writeFile(u, l.data), e.utime(u, Ne(l.modifyTime), Ne(l.modifyTime))) : l.type === D.DIRTYPE && (e.analyzePath(u).exists || e.mkdir(u));
	}
}
function br(e, r) {
	let t = [], n = (o) => {
...
async function kr(e) {
	let { promisify: r } = await import("./browser-external_util--CRpWttv.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)), { gzip: t } = await import("./browser-external_zlib-DY7IoIpv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	return await r(t)(e);
}
async function De(e) {
...
async function Rr(e) {
	let { promisify: r } = await import("./browser-external_util--CRpWttv.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)), { gunzip: t } = await import("./browser-external_zlib-DY7IoIpv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	return await r(t)(e);
}
function Ne(e) {
...
var Dr = (() => {
	...
	return async function(moduleArg = {}) {
		...
		if (ENVIRONMENT_IS_NODE) {
			let { createRequire: e } = await import("./browser-external_module-BdwAHJ-Z.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), r = import.meta.url;
			r.startsWith("data:") && (r = "/");
			var require = e(r);
		}
		...
		function findWasmBinary() {
			...
			return new URL("../../@electric-sql/pglite/dist/initdb.wasm", import.meta.url).href;
		}
		var wasmBinaryFile;
...
function Cr(e, r, t) {
	...
	return typeof n > "u" && t !== "" ? n = "" : typeof n > "u" && (n = "$"), typeof n == "object" ? r + C + JSON.stringify(n) + C : r + n;
}
function Br(e, r, t) {
	t || (t = {});
...
async function Yr({ pg: e, debug: r, args: t, wasmModule: n }) {
	let o, a, s, l = !1, u = [], d = 0, c = -1, p$2 = -1, f = "", m = "", _ = (S) => {
		let v = S.shift();
		G(r, "initdb: firstArg", v), zr(v === "/pglite/bin/postgres", `trying to execute ${v}`), e.Module.HEAPU8.set(g), G(r, "executing pg main with", S);
		let h = e.callMain(S);
		return G(r, h), u = [], h;
	}, g = e.Module.HEAPU8.slice(), y = await Ie({
		arguments: t,
		noExitRuntime: !1,
		thisProgram: Gr,
		stdin: () => null,
		...
		instantiateWasm: (S, v) => {
			let h = new URL("../../@electric-sql/pglite/dist/initdb.wasm", import.meta.url);
			return p.instantiateWasm(S, h, n).then(({ instance: b, module: F }) => {
				v(b, F);
			}), {};
		},
		preRun: [
			(S) => {
				S.ENV.PGDATA = B, S.ENV.HOME = "/home/postgres", S.ENV.USER = "postgres", S.ENV.LOGNAME = "postgres", S.ENV.ICU_DATA = jr;
			},
			(S) => {
				S.onRuntimeInitialized = () => {
					o = S.addFunction((v) => (u = Ge(S.UTF8ToString(v)), _(u)), "pi"), S._pgl_set_system_fn(o), a = S.addFunction((v, h) => {
						...
						if (b === "w") return l = !0, p$2;
						throw `Unexpected popen mode value ${b}`;
					}, "ppi"), S._pgl_set_popen_fn(a), s = S.addFunction((v) => v === c || v === p$2 ? (l && (l = !1, d = _(u)), d) : S._pclose(v), "pi"), S._pgl_set_pclose_fn(s);
					{
			...
			(S) => {
				S.FS.mkdir(I), S.FS.mount(S.PROXYFS, {
					root: I,
					fs: e.Module.FS
				}, I);
			}
	...
	return G(r, "calling initdb.main with", t), {
...
//#endregion
export { T as _, Re as a, u$1 as b, Ye as c, wt as d, p as f, R as g, P as h, I as i, at as l, L as m, B as n, Ve as o, F as p, Gr as r, We as s, At as t, jr as u, U as v, x, h$1 as y };
